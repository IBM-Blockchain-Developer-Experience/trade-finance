...
export const desc = 'import admins to trade finance';
...
export const builder = (yargs: Argv) => {
    ...
    yargs.usage('wt-cli import --wallet local_fabric/wallet --mspid Org1MSP --identity-name Admin@org1.example.com --public-cert cert.pem --private-key key.pem');
